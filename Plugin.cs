...
namespace KeyBindingServiceMeow
{
    public class Plugin : Plugin<Config>
    {
        ...
        public override void OnEnabled()
        {
            ...
            Exiled.Events.Handlers.Player.Joined += EventHandler.OnVerified;
        ...
        {
            Type ccmType = typeof(CharacterClassManager);
            var bindingFlags = BindingFlags.NonPublic | BindingFlags.Static;

            var enableSyncField = ccmType.GetField("EnableSyncServerCmdBinding", bindingFlags);

            if (enableSyncField == null)
                throw new Exception("The 'EnableSyncServerCmdBinding' field does not exist.");

            bool isEnabled = (bool)enableSyncField.GetValue(null);
    ...
    {
        public static void OnVerified(JoinedEventArgs ev)
        {
